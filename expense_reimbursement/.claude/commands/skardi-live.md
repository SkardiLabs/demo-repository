...
- **Skardi repo:** `/Users/bchen/code/skardi`
- **Required env vars** (set based on ctx sources):
  - MySQL: `MYSQL_USER`, `MYSQL_PASSWORD`
  - MongoDB: `MONGO_USER`, `MONGO_PASS`
- **Cargo run prefix:** `MYSQL_USER=skardi MYSQL_PASSWORD=skardi123 MONGO_USER=root MONGO_PASS=rootpass cargo run --manifest-path /Users/bchen/code/skardi/Cargo.toml --bin skardi-server --`
...
MYSQL_USER=skardi MYSQL_PASSWORD=skardi123 MONGO_USER=root MONGO_PASS=rootpass \
  cargo run --manifest-path /Users/bchen/code/skardi/Cargo.toml --bin skardi-server -- \
