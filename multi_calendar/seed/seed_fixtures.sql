...
('fixture-001', 'google', 'g-old-1', 'Weekly standup (stale copy)', NULL,
  strftime('%Y-%m-%dT%H:%M:%SZ', 'now', 'start of day', '+10 hours'),
  strftime('%Y-%m-%dT%H:%M:%SZ', 'now', 'start of day', '+10 hours', '+30 minutes'),
...
('fixture-001', 'feishu', 'f-old-1', 'Product review (stale copy)', NULL,
  strftime('%Y-%m-%dT%H:%M:%SZ', 'now', 'start of day', '+2 days', '+14 hours'),
  strftime('%Y-%m-%dT%H:%M:%SZ', 'now', 'start of day', '+2 days', '+15 hours'),
...
('fixture-002', 'feishu', 'f-1', '客户同步会 Customer sync', 'Weekly customer account review.',
  strftime('%Y-%m-%dT%H:%M:%SZ', 'now', 'start of day', '+10 hours', '+15 minutes'),
  strftime('%Y-%m-%dT%H:%M:%SZ', 'now', 'start of day', '+11 hours'),
  0, 'confirmed', 'Lin Hua',
...
('fixture-002', 'google', 'g-2', 'Company offsite', 'All hands offsite — see agenda doc.',
  strftime('%Y-%m-%dT%H:%M:%SZ', 'now', 'start of day', '+1 day'),
  strftime('%Y-%m-%dT%H:%M:%SZ', 'now', 'start of day', '+2 days'),
...
('fixture-002', 'google', 'g-3', '1:1 Boyang / Ada', NULL,
  strftime('%Y-%m-%dT%H:%M:%SZ', 'now', 'start of day', '+3 days', '+9 hours', '+30 minutes'),
  strftime('%Y-%m-%dT%H:%M:%SZ', 'now', 'start of day', '+3 days', '+10 hours', '+30 minutes'),
...
('fixture-002', 'google', 'g-4', 'Vendor call (cancelled)', NULL,
  strftime('%Y-%m-%dT%H:%M:%SZ', 'now', 'start of day', '+4 days', '+16 hours'),
  strftime('%Y-%m-%dT%H:%M:%SZ', 'now', 'start of day', '+4 days', '+17 hours'),
  0, 'cancelled', 'Ada Lovelace', '[]', NULL, NULL),
-- Next week (+8/+9/+11 days)
('fixture-002', 'feishu', 'f-3', 'Q3 规划 Planning', 'Quarter planning kickoff.',
  strftime('%Y-%m-%dT%H:%M:%SZ', 'now', 'start of day', '+8 days', '+11 hours'),
  strftime('%Y-%m-%dT%H:%M:%SZ', 'now', 'start of day', '+8 days', '+12 hours'),
...
('fixture-002', 'google', 'g-5', 'Design review — calendar demo', 'Walk through the skardi-styled week grid.',
  strftime('%Y-%m-%dT%H:%M:%SZ', 'now', 'start of day', '+9 days', '+15 hours'),
  strftime('%Y-%m-%dT%H:%M:%SZ', 'now', 'start of day', '+9 days', '+16 hours', '+30 minutes'),
...
('fixture-002', 'feishu', 'f-4', '团队午餐 Team lunch', NULL,
  strftime('%Y-%m-%dT%H:%M:%SZ', 'now', 'start of day', '+11 days', '+13 hours'),
  strftime('%Y-%m-%dT%H:%M:%SZ', 'now', 'start of day', '+11 days', '+14 hours'),
  0, 'confirmed', 'Lin Hua', '[]', NULL, NULL);
